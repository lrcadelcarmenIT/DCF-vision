  ...
  return <main className="workspace">
    ...
    <div className="workspace-body" id="workspace-content">
      ...
      <section className="project-path" aria-labelledby="project-path-title">
        <div className="project-path-heading"><div><p className="overline">CLIENT PROJECT PATH</p><h2 id="project-path-title">From factory visit to custom AI pilot</h2></div><span className="quiet-tag">6-WEEK BUILD</span></div>
        <p className="project-path-intro">This is the inspection workspace your team can use after we understand the line and collect approved production footage.</p>
        <ol className="project-path-steps"><li className="project-path-step is-current"><span className="project-path-number">01</span><div><strong>Visit the factory</strong><small>Map the line, product and inspection goal.</small></div><em>Start together</em></li><li className="project-path-step"><span className="project-path-number">02</span><div><strong>Record the line</strong><small>Collect normal production and defect examples.</small></div><em>Evidence needed</em></li><li className="project-path-step"><span className="project-path-number">03</span><div><strong>Build the custom system</strong><small>Train, connect and validate the pilot.</small></div><em>Six weeks</em></li></ol>
      </section>
